...
(function () {
  const DICT = {
    ru: {
      ...
      'st.fixed': 'закреплено', 'st.tentative': 'под вопросом', 'st.vacant': 'не закреплено',
      'team.fig1': 'Карта ответственности: что вокруг объекта и кто это держит',
      'team.fig2': 'Путь объекта и стыки, на которых он останавливается',
    ...
    pl: {
      ...
      'team.thState': 'Stan',
      'st.fixed': 'przypisane', 'st.tentative': 'do potwierdzenia', 'st.vacant': 'nieprzypisane',
      'team.fig1': 'Mapa odpowiedzialności: co otacza obiekt i kto to prowadzi',
      'team.fig2': 'Droga obiektu i styki, na których się zatrzymuje',
    ...
    en: {
      ...
      'team.thState': 'Status',
      'st.fixed': 'assigned', 'st.tentative': 'to confirm', 'st.vacant': 'unassigned',
      'team.fig1': 'Responsibility map: what surrounds a property and who holds it',
      'team.fig2': 'The path of a property and the joints where it stalls',
