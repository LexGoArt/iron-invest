...
(function () {
  const DICT = {
    ru: {
      ...
      'st.rented': 'готова, сдаётся', 'st.flat1': '2 спальни, 2 санузла, кухня, гостиная-столовая', 'st.flat2': '1 спальня, санузел, кухня-гостиная', 'f.listing': 'Листинг', 'st.shellbox': 'коробка без отделки',
    ...
    pl: {
      ...
      'st.rented': 'gotowe, wynajmowane', 'st.flat1': '2 sypialnie, 2 łazienki, kuchnia, salon z jadalnią', 'st.flat2': '1 sypialnia, łazienka, kuchnia z salonem', 'f.listing': 'Ogłoszenie', 'st.shellbox': 'stan surowy',
    ...
    en: {
      ...
      'st.rented': 'ready, let', 'st.flat1': '2 bedrooms, 2 bathrooms, kitchen, open living and dining', 'st.flat2': '1 bedroom, bathroom, open kitchen and living', 'f.listing': 'Listing', 'st.shellbox': 'shell, unfinished',
